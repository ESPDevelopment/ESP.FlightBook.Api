...
namespace ESP.FlightBook.Api.Extensions
{
    public static class ApiDbContextExtensions
    {
        ...
        private static void SeedApproachTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedCategoriesAndClasses(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedCertificateTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedCurrencyTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedEndorsementTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedEngineTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedGearTypes(ApiDbContext context)
        {
        ...
        /// </summary>
        /// <param name="context">Database context</param>
        private static void SeedRatingTypes(ApiDbContext context)
        {
